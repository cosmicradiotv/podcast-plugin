...
return [
    ...
    'show'         => [
        ...
        'feed_language_comment'       => 'Allowed languages: http://cyber.law.harvard.edu/rss/languages.html',
        'feed_copyright'              => 'Copyright notice',
        'feed_author'                 => 'Feed Author',
        'itunes_category'             => 'iTunes Category',
        'itunes_category_comment'     => "Enter a category per row. For subcategories put it after the parent, with one space infront.\nList of categories: https://www.apple.com/itunes/podcasts/specs.html (bottom). Characters like & are automatically escaped.",
        'itunes_category_placeholder' => "Category & Things",
        'itunes_explicit'             => 'Explicit tag',
        'itunes_owner_name'           => 'Owner Name',
        'itunes_owner_email'          => 'Owner E-mail',
        'tab_rss'                     => 'RSS Feed',
        'tab_itunes'                  => 'iTunes',
        # Actions and statuses
        'create'                      => 'Create Show',
